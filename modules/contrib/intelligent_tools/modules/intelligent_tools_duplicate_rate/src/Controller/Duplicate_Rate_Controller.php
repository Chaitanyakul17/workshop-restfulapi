 ...
 *
 */
class Duplicate_Rate_Controller extends ControllerBase {
  ...
  public function adminOverview(Request $request) {
    ...
    $build['path_table'] = [
      ...
      '#header' => $header,
      '#rows' => $rows,
      '#empty' => $this->t('No settings available. <a href=":link">Add Settings</a>.', [':link' => Url::fromRoute('intelligent_tools_duplicate_rate_addone.settings')->toString()]),
    ];

...
namespace Drupal\intelligent_tools_text_summarize\Controller;
 ...
 *
 */
class Text_Summarize_Controller extends ControllerBase {
  ...
  public function adminOverview(Request $request) {
    ...
    foreach ($some_array as $data) {
      ...
      $operations['edit'] = [
        'title' => $this->t('Edit'),
        'url' => Url::fromRoute('intelligent_tools_text_summarize_form.settings', ['pid' => $string_data]),
      ];
      $operations['delete'] = [
        'title' => $this->t('Delete'),
        'url' => Url::fromRoute('intelligent_tools_text_summarize_del.settings', ['pid' => $string_data]),
      ];
      $row['data']['operations'] = [
        'data' => [
          '#type' => 'operations',
    ...
    $build['path_table'] = [
      ...
      '#header' => $header,
      '#rows' => $rows,
      '#empty' => $this->t('No settings available. <a href=":link">Add Settings</a>.', [':link' => Url::fromRoute('intelligent_tools_text_summarize_addone.settings')->toString()]),
    ];
